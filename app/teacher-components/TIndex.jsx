        ...
        <section className="bg-img icon icon-image" style={{ height: viewHeight }}>
          <div className="mask">
            <div className="content">
              ...
              {
                this.props.token ? <div /> : <RaisedButton className="index-start-btn" style={startStyle} labelStyle={labelStyle} label="Start Teaching" primary onTouchTap={this.handleStart} />
              }
            </div>
          </div>
