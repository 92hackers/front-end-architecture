  ...
  render() {
    return (
      <div>
        ...
        <p>
          <strong>Ensure the students sees well organized content.</strong>
          The screen you present to your student using Zoom’s “Share Screen” function is akin to a traditional classroom’s blackboard; all material on display should be relevant and focused.
        </p>
